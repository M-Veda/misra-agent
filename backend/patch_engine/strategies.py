...
class BasePatchStrategy(PatchStrategy):
    name = "base"
...
class TextPatchStrategy(BasePatchStrategy):
    name = "text_patch"
...
class RegexPatchStrategy(BasePatchStrategy):
    name = "regex_patch"
...
class AIPatchStrategy(BasePatchStrategy):
    name = "ai_patch"
...
class ManualPatchStrategy(BasePatchStrategy):
    name = "manual_patch"
